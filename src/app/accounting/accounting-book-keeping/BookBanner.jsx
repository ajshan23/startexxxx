...
import BannerImg from '../../../../public/assets/images/accounting/book-banner.webp'

import ConsultantModal from '../../components/ConsultantModal' // ✅ Adjust path
        ...
        <div className='md:w-1/2'>
          ...
          >
            ...
            <p className='font-[300] md:text-[17px] text-[14px] text-secondary pt-3'>
              Record monetary transactions securely to optimize the financial
              resources of your company in Dubai, UAE.
            </p>
