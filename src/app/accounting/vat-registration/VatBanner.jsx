...
import BannerImg from '../../../../public/assets/images/accounting/vat-banner.webp'

import ConsultantModal from '../../components/ConsultantModal' // ✅ Update the path if needed
...
function VatBanner() {
  ...
  const [selectedService, setSelectedService] = useState('VAT Registration')
