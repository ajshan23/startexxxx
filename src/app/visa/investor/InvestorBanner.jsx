...
import LicensingBannerImg from '../../../../public/assets/images/licensing/v1.webp'
        ...
        <div className='md:w-1/2'>
          ...
          >
            ...
            <h1 className='md:text-[50px] text-[27px] font-[500] pt-3 text-gradient'>
              Investor Visa Service in Dubai, UAE
            </h1>
            <p className='font-[300] md:text-[17px] text-[14px] text-secondary pt-3'>
              Walk in on a red carpet to one of the most business-friendly
