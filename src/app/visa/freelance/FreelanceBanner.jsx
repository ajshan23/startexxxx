...
import LicensingBannerImg from '../../../../public/assets/images/licensing/v6.webp'
        ...
        <div className='md:w-1/2'>
          ...
          >
            ...
            <h1 className='md:text-[50px] text-[27px] font-[500] pt-3 text-gradient'>
              Freelance Visa Service in Dubai, UAE
            </h1>
            <p className='font-[300] md:text-[17px] text-[14px] text-secondary pt-3'>
              Unleash your creative skills and enjoy limitless opportunities in
              Dubai, UAE.
            </p>
