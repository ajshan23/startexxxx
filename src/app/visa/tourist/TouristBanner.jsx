...
import LicensingBannerImg from '../../../../public/assets/images/licensing/v4.webp'
...
function TouristBanner() {
  ...
  return (
    ...
    Tourist Visa Service in Dubai, UAE
            </h1>
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
         Enjoy a vacation in the land of opportunities, Dubai.
            </p>
