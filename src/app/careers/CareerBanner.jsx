...
import aboutbanner from '../../../public/assets/images/about/abt-banner.webp'
      ...
      <div className=' pt-10 items-center main-pt px-4 md:px-8 lg:px-[90px] relative z-40 gap-20'>
        <div className=''>
          ...
          >
            ...
            <p className='text-[16px] pt-5 text-center text-white'>
              At Startex Hub, we’re committed to empowering businesses to grow
              and succeed in Dubai and throughout the UAE. From launching
              startups to scaling established enterprises, our team is at the
              heart of every success story. We’re on the lookout for passionate,
              skilled, and forward-thinking professionals who are ready to make
              an impact. If you’re driven by innovation and thrive in a dynamic
              environment, we’d love to have you join us in delivering
              outstanding service and shaping the future of business in the
              region.
            </p>
          </motion.div>
        </div>
