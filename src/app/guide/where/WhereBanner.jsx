...
import LicensingBannerImg from '../../../../public/assets/images/licensing/where.webp'
      ...
      <div className='md:flex pt-10 items-center main-pt px-4 md:px-8 lg:px-[90px] relative z-40 gap-20'>
        <div className='md:w-1/2'>
          ...
          >
           ...
           Dubai is where business dreams soar, offering global opportunities at your doorstep. With expert guidance from Startex Business Setup Services, success starts here.
            </p>
