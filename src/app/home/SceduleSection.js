...
function SceduleSection() {
  ...
  const callCardInView = useInView(callCardRef, { amount: 0.3, once: true });
  const sliderInView = useInView(sliderRef, { amount: 0.3, once: true });
  const chatInView = useInView(chatRef, { amount: 0.3, once: true });
  ...
  return (
    <div className='px-4 md:px-8 xl:px-[250px] mx-auto text-white'>
      <section className="py-0 md:py-20 md:pt-0">
        ...
        <div className="flex flex-col md:flex-row md:gap-6 lg:gap-10 xl:gap-20 w-full items-start ">
