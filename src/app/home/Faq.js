...
function Faq() {
    ...
    return (
        <div className='md:px-8 lg:px-[90px] px-4  md:py-20 py-10'>
            <div className='relative md:pt-10 pt-5 pb-10'>
                <p className='md:text-[18px] text-center text-[16px] font-[300] pt-5  text-white'>FAQ&#39;S.</p>
                <h3 className='md:text-[50px] text-[27px] text-center font-[400] text-white ps-5 '>Have questions ?</h3>

                <div className='md:p-10 relative z-50 pt-5'>
                    <FaqAccordion />
                </div>
                ...
                <div className='absolute bottom-0 md:right-[-80px] w-[170px] z-[-5] h-full  opacity-[0.5]'>
                    <Image
                        src={Asset1}
                        alt="License Card"
                        width={500}
                ...
                <div className='absolute bottom-0 left-[-80px] w-[170px] z-[-5] h-[170px] opacity-[0.5]'>
                    <Image
                        src={Asset2}
                        alt="License Card"
                        width={500}
