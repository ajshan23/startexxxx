...
import BannerImg from "../../../../public/assets/images/licensing/o-banner.webp";
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
              Explore Professional License Options in Dubai
            </h6>
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
             Owning a professional license is your license to excel in your business ventures in Dubai, UAE.
            </p>
