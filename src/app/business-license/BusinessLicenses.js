...
function BusinessLicenses() {
  ...
  return (
    <div className='px-4 md:px-8 lg:px-[90px] pt-10 md:pb-10' id='business-licenses'>
      ...
      <p className='md:text-[16px] text-[15px] font-[300] pt-5 md:w-[70%] m-auto text-secondary text-center pb-10 md:pb-0'>
        Discover the range of business licenses we offer, designed to support your ventures unique needs and help you succeed in Dubais dynamic market.
      </p>
