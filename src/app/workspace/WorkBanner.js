...
import WorkingBannerImg from "../../../public/assets/images/workspace/w-banner.webp";
        ...
        <div className="md:w-1/2">
          ...
          >
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Find office space in a strategic location with Startex to turn the
              business landscape in favor of your venture
            </p>
            <div className="pt-10 flex gap-8">
             <Link href="#office-space-card"> <button className="gr-btn">Office Spaces</button></Link>
