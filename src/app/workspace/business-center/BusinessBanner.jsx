...
import BankBannerImg from "../../../../public/assets/images/workspace/busines-banner.webp";
import ConsultantModal from "../../components/ConsultantModal"; // ✅ Adjust path as needed
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
              Fully Equipped Office Spaces in Dubai
            </h6>
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Launch your business and position yourself in Dubai’s thriving
              economy with a professional business center rental.
            </p>
