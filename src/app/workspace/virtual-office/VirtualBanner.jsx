...
import BankBannerImg from "../../../../public/assets/images/workspace/v-banner.webp";
import ConsultantModal from "../../components/ConsultantModal"; // ✅ Ensure the correct path
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
              Professional Business Address in Dubai
            </h6>
            ...
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Establish your business presence in Dubai with a virtual office —
              ideal for startups, freelancers, and remote teams seeking a
              premium address without physical space.
            </p>
