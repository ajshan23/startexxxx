...
import BankBannerImg from "../../../../public/assets/images/workspace/f-banner.webp";
import ConsultantModal from "../../components/ConsultantModal"; // ✅ Adjust the path if needed
        ...
        <div className="md:w-1/2">
          ...
          >
            <h6 className="md:text-[18px] text-[16px] font-[300] text-gradient">
              Affordable & Flexible Workspaces in Dubai
            </h6>
            <h1 className="md:text-[50px] text-[27px] font-[500] pt-3 text-gradient">
              Flexi Desk Office <br />
              in Dubai, UAE
            </h1>
            <p className="font-[300] md:text-[17px] text-[14px] text-secondary pt-3">
              Kickstart your business journey in Dubai with a cost-effective
              Flexi Desk solution designed for flexibility and convenience.
            </p>
